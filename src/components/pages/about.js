  ...
  return (
    <div className="about flex flex-col items-center">
      ...
      <div className="body flex flex-col items-center">
        ...
        {/* huge photo */}
        <div className="bg-biglitto bg-cover bg-bottom w-full height"></div>
        ...
        {/* our pillars */}
        <div className="flex flex-col items-center justify-center height md:-mt-20">
          <h1 className="text-4xl sm:text-5xl px-10 text-red-800 abhaya">Our Pillars</h1>
          ...
          <div className="flex flex-col items-start lg:flex-row pb-12 mx-12">
            <div className="flex flex-col items-center pt-8 w-full lg:w-1/3">
              <h1 className="text-3xl sm:text-4xl px-10 text-red-800 abhaya">Brotherhood</h1>
              <div className="border w-36 border-red-800 my-5"></div>
              <p className="text-lg leading-9 text-center px-12 italic font-extralight">We strive to develop bonds between our brothers that will last a lifetime.</p>
              <div className="bg-handshake bg-cover bg-bottom h-44 w-44"></div>
            </div>
            <div className="flex flex-col items-center pt-8 w-full lg:w-1/3">
              <h1 className="text-3xl sm:text-4xl px-10 text-red-800 abhaya">Philanthrophy</h1>
              <div className="border w-36 border-red-800 my-5"></div>
              <p className="text-lg leading-9 text-center px-12 italic font-extralight">We are involved in projects that give back to the community around us.</p>
